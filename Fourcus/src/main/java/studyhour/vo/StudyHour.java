...
public class StudyHour {
    ...
    private LocalDateTime reStartTime = null;   // 공부 재시작 시각
    private LocalDateTime stopTime = null;  // 종료 시각
    private long cumulativeTime = 0;   // 누적 시간
    private long maxFocusTime = 0;    // 최대 집중 시간
